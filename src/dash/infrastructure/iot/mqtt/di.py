...
from dash.presentation.iot_callbacks.mqtt.sys import (
    sys_connect_callback,
    sys_disconnect_callback,
)
from dash.presentation.iot_callbacks.mqtt.tasmota import tasmota_callback
...
async def get_mqtt_client(
    ...
    async with MqttClient(
        ...
        client.dispatcher.sys_connect.register_callback(sys_connect_callback)  # type: ignore
        client.dispatcher.sys_disconnect.register_callback(sys_disconnect_callback)  # type: ignore
        yield client
