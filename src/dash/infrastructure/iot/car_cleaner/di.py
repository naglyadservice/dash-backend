...
from dash.presentation.iot_callbacks.car_cleaner.encashment import (
    car_cleaner_encashment_callback,
)
...
async def get_car_cleaner_client(
    ...
    async with CarCleanerIoTClient(
        ...
        client.dispatcher.encashment.register_callback(car_cleaner_encashment_callback)  # type: ignore
        yield client
