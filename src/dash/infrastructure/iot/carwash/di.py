...
from dash.infrastructure.iot.common.base_iot import BaseIoTDispatcher
...
) -> AsyncIterator[CarwashIoTClient]:
    async with CarwashIoTClient(
        host=config.host,
        port=config.port,
        ...
        client.dispatcher.payment_card_get.register_callback(carwash_payment_card_get_callback)  # type: ignore
